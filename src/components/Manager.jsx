...
const Manager = () => {
    ...
    return (
        <>
            ...
            <div className='p-2 pt-3 md:mycontainer min-h-[85vh]'>
                ...
                <div className='text-black gap-8 flex flex-col p-4 items-center'>
                    ...
                    <button onClick={savePassword} className='gap-2 flex justify-center items-center bg-green-400 hover:bg-green-300 rounded-full px-8 border border-green-900 py-2 w-fit'>
                        <lord-icon
